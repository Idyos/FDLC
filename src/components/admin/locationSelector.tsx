...
const apiKey = import.meta.env.VITE_GOOGLE_MAPS_API_KEY || "";
  ...
  return (
    <APIProvider apiKey={apiKey}>
      ...
      >
        {position && (
          <AdvancedMarker draggable={true} onDragEnd={(e) => handleMapDrag(e)} onDrag={() => console.log("Dragging map")} clickable={true} onClick={() => setPosition(null)} position={position} title={"Ubicació de la prova"} collisionBehavior="OPTIONAL_AND_HIDES_LOWER_PRIORITY">
